namespace Skyline.DataMiner.CICD.Tools.CatalogUpload.Lib
{
	...
	public class CatalogMetaData
	{
		...
		/// </summary>
		/// <param name="startPath">The starting directory path for the catalog YAML file.</param>
		/// <param name="pathToReadme">Optional. The path to the README file.</param>
		/// <param name="pathToImages">Optional. The path to the images directory.</param>
		/// <returns>A <see cref="CatalogMetaData"/> instance populated with the catalog YAML data.</returns>
		public static CatalogMetaData FromCatalogYaml(IFileSystem fs, string startPath, string pathToReadme = null, string pathToImages = null)
		{
